...
public class DepositEntity {
    ...
    public DepositEntity(BankMessage bankMessage) {
        this.from = bankMessage.getFrom();
        this.name = bankMessage.getName();
        this.content = bankMessage.getContent();
    ...
    public BankMessage getDepositMessage() {
        return new BankMessage(this.from,
                this.name,
